...
public class TaskListImpl implements ITaskList {
     ...
     * 
     * This method had a lot of parameters which is a code smell. 
     * To fix this, I created a separate class TaskDetail that holds all the detail of a task and
     * I passed it as an object of that class.
     */
    public ITask createTask(CalendarDate startDate, CalendarDate endDate, TaskDetail detail, String parentTaskId) {
        ...
        el.addAttribute(new Attribute("effort", String.valueOf(detail.getEffort())));
        el.addAttribute(new Attribute("priority", String.valueOf(detail.getPriority())));
                
        Element txt = new Element("text");
        txt.appendChild(detail.getText());
        el.appendChild(txt);

        Element desc = new Element("description");
        desc.appendChild(detail.getDescription());
        el.appendChild(desc);
