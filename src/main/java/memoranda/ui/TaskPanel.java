...
import main.java.memoranda.TaskDetail;
...
//        CalendarDate ed = new CalendarDate((Date) dlg.endDate.getModel().getValue());
		...
		ITask newTask = CurrentProject.getTaskList().createTask(sd, ed, new TaskDetail(dlg.todoField.getText(),dlg.descriptionField.getText() , dlg.priorityCB.getSelectedIndex(),effort),null);
...
//        CalendarDate ed = new CalendarDate((Date) dlg.endDate.getModel().getValue());
 		...
 		if(dlg.chkEndDate.isSelected())
 			...
 			ed = null;
        long effort = Util.getMillisFromHours(dlg.effortField.getText());
		ITask newTask = CurrentProject.getTaskList().createTask(sd, ed, new TaskDetail(dlg.todoField.getText(),  dlg.descriptionField.getText(), dlg.priorityCB.getSelectedIndex(),effort),parentTaskId);
        newTask.setProgress(((Integer)dlg.progress.getValue()).intValue());
//		CurrentProject.getTaskList().adjustParentTasks(newTask);
